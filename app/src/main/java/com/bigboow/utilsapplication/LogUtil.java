...
public class LogUtil {
    public static String tagPrefix = "bigboowlog";
    ...
    private static String generateTag() {
        ...
        String tag = "%s.%s(L:%d)";
        tag = String.format(Locale.getDefault(),tag, callerClazzName, stackTraceElement.getMethodName(), stackTraceElement.getLineNumber());
